...
(function() {
  var AdmZip, TVDB, defaultOptions, fs, http, querystring, xmlParser, _;
  ...
  TVDB = (function() {
    ...
    TVDB.prototype.unzip = function(zipBuffer, fileToExtract, done) {
      return done(null, new AdmZip(zipBuffer));
    };
    ...
    TVDB.prototype.getInfo = function(mirrorUrl, tvShowId, done, language) {
      ...
      return this.get({
        ...
        var formattedTvShows, keyMapping, tvShows;
        if (err != null) {
          done(err);
          return;
        }
