 ...
 * 
 * A mirror is an object containing `id`, `url` and an array of `types` containing at least one of `xml`, `banner` and `zip`.
 * 
 * @param {Function} done
 * @api public
 */
TheTVDB.prototype.getMirrors = function(done) {
  this.get({ path: this.getPath("mirrors") }, function(err, response) {
