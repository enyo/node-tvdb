...
I use the great [mocha testing framework](https://mochajs.org/) with the (also great) [should assertion library](https://github.com/visionmedia/should.js) for testing.  
